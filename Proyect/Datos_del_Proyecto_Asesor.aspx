<%@ Page Title="Proyectos de Asesor" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Datos_del_Proyecto_Asesor.aspx.cs" Inherits="GEIP_UPT.Datos_del_Proyecto_Asesor" %>
...
<head>
    <meta charset="utf-8">
    <title>Proyectos de Asesor</title>
    ...
    <script type="text/javascript">
        ...
        function clickView(id) {
            ...
            function drpChange(e) {
                ...
                if ($(e).val() == "0") {
                    $("#modalStatusText").text("Justificación de inactividad: ");
                    $('#<%= Tb_descripcion.ClientID %>').show();
                } else {
                    $("#modalStatusText").html("Para confirmar el cambio de estado: <strong>ACTIVO</strong> seleccione Guardar Cambios ");
        ...
        function drpChangePendientes(e) {
            ...
            if (val == "0") {
                $("#modalStatusText").text("El proyecto regresará a estado <strong>PENDIENTE</strong>");
                $('#<%= Tb_descripcion.ClientID %>').hide();
                } else {
                $("#modalStatusText").html("El proyecto se enviará a el administrador");
                    $('#<%=Tb_descripcion.ClientID %>').hide();
            }
