<%@ Page Title="Lectura de Impacto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Lectura_Impacto.aspx.cs" Inherits="GEIP_UPT.Lectura_Impacto" %>
...
<head>
    <meta charset="utf-8">
    <title>Lectura de Impacto</title>
...
<body>
    ...
    <main>
    	<h3 class="pt-8" align="center">Impacto</h3>
        <div class="container-fluid p-50 " style="margin-bottom: 8px;">
	        ...
	        <div class="row pt-39 d-flex justify-content-center ">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <a href="Registrar_Impacto.aspx" class="btn btn-info" >Registrar</a>
                </div>
