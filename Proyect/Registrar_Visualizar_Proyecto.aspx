<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registrar_Visualizar_Proyecto.aspx.cs" Inherits="GEIP_UPT.Registrar_Visualizar_Proyecto" %>
...
<body>
    ...
    <main>
    	...
    	<div class="row pt-5 pb-60">
    		<div class="col-xs-12 col-sm-12 col-md-12">
    			 <nav class="navbar navbar-expand-lg navbar-dark" style="background: #fff; ">
         
            <div class="navbar navbar-nav  navbar-collapse ">

                <ul class="nav navbar-nav  navbar-collapse navbar-center
                ">

                    <li class="active" style="padding-left: 90px;"><a href="#" target="_self">Registrar proyecto</a></li>
                    <li class="active" style="padding-left: 180px;"><a href="#" target="_self">Visualizar proyecto</a></li>
