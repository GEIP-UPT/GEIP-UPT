<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registro_completo_Integrantes.aspx.cs" Inherits="GEIP_UPT.Registro_completo_Integrantes" %>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-light bg-UPT" style="background-image:  url(imagenes/head.png);  ">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="#" target="_self">Registros Completo de Integrantes</a></li>
...
<br>
    <main>
        <h3 class="pt-8" align="center">Registro de integrantes</h3>
        <div class="container-fluid p-15">
            <div class="row">
                <div class="col-12 col-lg-">
                    ...
                    <center><input type="text" placeholder="Ingrese su Nombre" class="shadow-lg"> <select name="Edad">
            ...
            <center><input type="text" placeholder="Ingrese apellido materno" class="shadow-lg"> <input type="text" placeholder="Ingrese correo electronico" class="shadow-lg">
                         ...
                         <center><input type="text" placeholder="Ingrese apellido paterno" class="shadow-lg"><input type="text" placeholder="Ingrese contraseña" class="shadow-lg">
                                      ...
                                      <div class="input-contenedor">
                                    <i class="fas fa-user icon"></i>
                         <center><input type="text" placeholder="Ingrese Matricula" class="shadow-lg">    <select name="Programa_educativo">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <button class="btn btn-info pt-8" >Regresar</button>    <button class="btn btn-info pt-8" >Finalizar</button>
        </div>
