<%@ Page Title="Edición de TiposProyecto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Modificar_TiposProyecto.aspx.cs" Inherits="GEIP_UPT.Modificar_TiposProyecto" %>
...
<head>
    <meta charset="utf-8">
    <title>Modificar Tipos de Proyecto</title>
...
<body>
    ...
    <main>
    	<h3 class="pt-8" align="center">Modificación de Tipos de Proyecto</h3>
        <div class="container-fluid p-50 " style="margin-bottom: 8px;">
	        ...
	        <div class="row pt-39 text-center">
		        <div class="col-xs-12 col-sm-12 col-md-12 mb-38">
                         ...
                         <asp:Button ID="btnEditTiposProy" runat="server" Text="Modificar" OnClick="btnEditTiposProy_Click" />
