<%@ Page Title="Registro de Programas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registrar_Programas.aspx.cs" Inherits="GEIP_UPT.Registrar_Programas" %>
...
<body>
    ...
    <main>
    	<h3 class="pt-8" align="center">Registro de Programas</h3>
        <div class="container-fluid p-50 " style="margin-bottom: 8px;">
	        ...
	        <div class="row pt-39 text-center">
		        <div class="col-xs-12 col-sm-12 col-md-12 mb-38">
                             ...
                             <asp:TextBox ID="txtProgramas" runat="server"></asp:TextBox>
                         <asp:Button ID="btnRegProgramas" runat="server" Text="Registrar" OnClick="btnRegProgramas_Click" />
			...
			<a href="Lectura_Programas.aspx" class="btn btn-info" >Regresar</a>
                 <//div>
