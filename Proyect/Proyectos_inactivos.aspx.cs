...
namespace GEIP_UPT
{
    public partial class Proyectos_inactivos : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Lb_Justificacion.Text = "Razón inactividad: " + justificacionInactividad;
        ...
        {
            DataSet ids = cBD.proyectosInActivos();
