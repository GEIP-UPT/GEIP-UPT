<%@ Page Title="Registro de Impacto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registrar_Impacto.aspx.cs" Inherits="GEIP_UPT.Registrar_Impacto" %>
...
<head>
    <meta charset="utf-8">
    <title>Registro de Impacto</title>
...
<body>
    ...
    <main>
    	<h3 class="pt-8" align="center">Registro de Impacto</h3>
	        ...
	        <div class="row pt-120">
		        <div class="col-xs-12 col-sm-12 col-md-12 mb-38">
                     ...
                     <div  class="table-responsive">     
                             <asp:TextBox ID="txtImpacto" runat="server"></asp:TextBox>
                         <asp:Button ID="btnRegImpacto" runat="server" Text="Registrar" OnClick="btnRegImpacto_Click" />
                        <a href="Lectura_Impacto.aspx" class="btn btn-info" >Regresar</a>
                     </div>
