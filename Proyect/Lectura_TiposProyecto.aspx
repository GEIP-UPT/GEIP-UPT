<%@ Page Title="Lectura de TiposProyecto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Lectura_TiposProyecto.aspx.cs" Inherits="GEIP_UPT.Lectura_TiposProyecto" %>
...
<head>
    <meta charset="utf-8">
    <title>Lectura de Tipos de Proyecto</title>
...
<body>
    ...
    <main>
    	<h3 class="pt-8" align="center">Tipos de Proyecto</h3>
	        ...
	        <div class="row pt-39 d-flex justify-content-center ">
		        <div class="col-10 mb-38">
                 ...
                 <div class="col-xs-12 col-sm-12 col-md-12">
                   <a href="Registrar_TiposProyecto.aspx" class="btn btn-info" >Registrar</a>
                </div>
	        </div>                         
                  </div>
    </main>
