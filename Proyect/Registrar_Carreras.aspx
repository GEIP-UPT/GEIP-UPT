<%@ Page Title="Registro de Carreras" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registrar_Carreras.aspx.cs" Inherits="GEIP_UPT.Registrar_Carreras" %>
...
<body>
    ...
    <main>
    	<h3 class="pt-8" align="center">Registro de Carreras</h3>
        <div class="container-fluid p-50 " style="margin-bottom: 8px;">
	        ...
	        <div class="row pt-39 text-center">
		        <div class="col-xs-12 col-sm-12 col-md-12 mb-38">
                         ...
                         <asp:Button ID="btnRegCarrera" runat="server" Text="Registrar" OnClick="btnRegCarrera_Click" />
			...
			<a href="Lectura_Carreras.aspx" class="btn btn-info" >Regresar</a>
                 <//div> 
