<%@ Page Title="Alumnos Lectores" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AlumnosLectores.aspx.cs" Inherits="GEIP_UPT.AlumnosLectores" %>
...
<body>
    ...
    <header>
      ...
      <main>
    	<h3 class="pt-8" align="center">Alumnos lectores</h3>
        <div class="container-fluid p-50 mb-38">
           
                          <%--////////////////////////////////////////////////////////////////////////////////////////////--%>
             <div class="row d-flex justify-content-center">
            <div class="col-10 mb-38">
                <asp:Table ID="TablaLectores" 
            runat="server" 
            CellPadding="10"
            CellSpacing="10"
            BackColor="White"
