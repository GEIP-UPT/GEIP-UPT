<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Proyectos_disponibles.aspx.cs" Inherits="GEIP_UPT.Proyectos_disponibles" %>
        ...
        <div class="container-fluid p-50 mb-38">
                         ...
                         <div class="table-responsive">
                         	<table class="table active table-border table-hover table-condensed ">
                            		...
                            		<tr>
                            			<td><a href="Datos_del_Proyecto_Adm.html">dat1</a></td>
                            			<td>dat2</td>
      									<td>dat3</td>
                            			<td>dat4</td>
                            			<td>dat5</td>
