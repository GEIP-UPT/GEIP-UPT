                    ...
                    <div class="container-fluid p-0">
                        <div class="row">
                            <div class="col-12 mb-15">
                                        ...
                                        <center><asp:TextBox ID="Tb_descripcion" runat="server" placeholder="Descripción del proyecto" class="shadow-lg"></asp:TextBox> </center>
                                        <center><asp:TextBox ID="Tb_contactoLider" runat="server" placeholder="Datos de contacto líder" class="shadow-lg"></asp:TextBox></center>
  ...
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    ...
    <script type="text/javascript">
        ...
        function guardarProyecto() {
            ...
            var cont = document.getElementById('<%= Tb_contactoLider.ClientID %>').value;
            ...
            document.getElementById('<%= Tb_contactoLider.ClientID %>').style.backgroundColor = (cont == '') ? "PaleVioletRed" : "White";


            if (recurss == '' || descr == '' || cont == '') {
                ...
                contacto: document.getElementById('<%= Tb_contactoLider.ClientID %>').value
                };
        ...
        function obtenerProyecto_p4() {
            ...
            if (proyecto != "") {
                ...
                document.getElementById('<%= hf_contactoL.ClientID %>').value = proyecto.contacto;
            }
        ...
        function obtenerProyecto() {
            ...
            if (proyecto != "") {
                ...
                document.getElementById('<%= Tb_contactoLider.ClientID %>').value = proyecto.contacto;
            }
        }
