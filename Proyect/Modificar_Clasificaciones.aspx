<%@ Page Title="Edición de Clasificaciones" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Modificar_Clasificaciones.aspx.cs" Inherits="GEIP_UPT.Modificar_Clasificaciones" %>
...
<head>
    <meta charset="utf-8">
    <title>Modificar Clasificaciones</title>
...
<body>
    ...
    <main>
    	<h3 class="pt-8" align="center">Modificación de Clasificaciones</h3>
	        ...
	        <div class="row pt-120">
		        <div class="col-xs-12 col-sm-12 col-md-12 mb-38">
                     ...
                     <div  class="table-responsive">     
                         ...
                         <asp:Button ID="btnEditClasif" runat="server" Text="Modificar" OnClick="btnEditClasif_Click" />
                     </div>
