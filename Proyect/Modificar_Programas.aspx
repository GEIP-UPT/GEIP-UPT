<%@ Page Title="Edición de Programas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Modificar_Programas.aspx.cs" Inherits="GEIP_UPT.Modificar_Programas" %>
...
<body>
    ...
    <main>
    	<h3 class="pt-8" align="center">Modificación de Programas</h3>
        <div class="container-fluid p-50 " style="margin-bottom: 8px;">
           
 
                            	
	        <div class="row pt-39 text-center">
		        <div class="col-xs-12 col-sm-12 col-md-12 mb-38 te">
			
                     
                             <asp:TextBox ID="txtProy" runat="server"></asp:TextBox>
                         <asp:Button ID="btnEditProy" runat="server" Text="Modificar" OnClick="btnEditProy_Click" />
