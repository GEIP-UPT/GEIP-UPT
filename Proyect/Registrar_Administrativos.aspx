<%@ Page Title="Registro de Administrativos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registrar_Administrativos.aspx.cs" Inherits="GEIP_UPT.Registrar_Administrativos" %>
...
<body>
    ...
    <main>
    	<h3 class="pt-8" align="center">Registro de Administrativos</h3>
		        ...
		        <div class="col-xs-12 col-sm-12 col-md-12 mb-38">
                     ...
                     <div  class="table-responsive">     
                         ...
                         <asp:Label ID="Label3" runat="server" Text="Contraseña"></asp:Label><asp:TextBox ID="txtPass" runat="server"></asp:TextBox>
                             <br />
                         <asp:Label ID="Label5" runat="server" Text="Contacto"></asp:Label>&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtContacto" runat="server"></asp:TextBox>
                             <br />
                         <asp:Label ID="Label4" runat="server" Text="Area"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtArea" runat="server"></asp:TextBox>
                             <br />
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                             <br />
                         <asp:Button ID="btnRegAdmin" runat="server" class="btn btn-info" Text="Registrar" OnClick="btnRegAdmin_Click" />
                        <a href="Lectura_Administrativos.aspx" class="btn btn-info" >Regresar</a>
                     </div>
