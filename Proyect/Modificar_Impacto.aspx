<%@ Page Title="Edición de Impacto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Modificar_Impacto.aspx.cs" Inherits="GEIP_UPT.Modificar_Impacto" %>
...
<body>
    ...
    <main>
    	<h3 class="pt-8" align="center">Modificación de Impacto</h3>
        <div class="container-fluid p-50 " style="margin-bottom: 8px;">
	        ...
	        <div class="row pt-39 text-center">
		        <div class="col-xs-12 col-sm-12 col-md-12 mb-38">
                         ...
                         <asp:Button ID="btnEditImpacto" runat="server" Text="Modificar" OnClick="btnEditImpacto_Click" />
