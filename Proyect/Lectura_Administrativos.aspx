<%@ Page Title="Lectura de Administrativos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Lectura_Administrativos.aspx.cs" Inherits="GEIP_UPT.Lectura_Administrativos" %>
...
<head>
    <meta charset="utf-8">
    <title>Lectura de Administrativos</title>
                             ...
                             <asp:Table  id="tblCarreras"
                                       ...
                                       class="table active table-border table-hover table-condensed "
                                        ...
                                        <asp:TableHeaderRow 
                                            ...
                                            <asp:TableHeaderCell>Contacto</asp:TableHeaderCell>
